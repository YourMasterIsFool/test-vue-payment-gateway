...
<template>
  <div>
    <MainContent title="Deposit">
      <div>
        Selamat datang pada test payment gateway, di bawah ini adalah penjelasan tentang parameter penggunaan Deposit
      </div>

      <!-- Parameter Request -->
      <div class="lg:mt-6 mt-4">
        <h1 class="font-bold text-gray-800">Parameter request untuk fitur deposit</h1>
        ...
        <p class="flex items-center lg:mt-6 lg:mb-6 mb-3 mt-4 text-black space-x-3">
          ...
          <span class="font-bold">http://localhost:8000/api/deposit</span>
        </p>
        ...
        <div class="md:mt-6">
          <router-link to="/test-deposit" class="btn btn-primary w-64">Coba Tes Deposit</router-link>
        </div>
      </div>

      <!-- Parameter Response -->
      <div class="lg:mt-6 mt-4">
        <h1 class="font-bold text-gray-800">Parameter Response untuk fitur deposit</h1>
        <p class="flex items-center lg:mt-6 mt-4 text-black space-x-3">
          <span class="font-normal">METHOD:</span>
